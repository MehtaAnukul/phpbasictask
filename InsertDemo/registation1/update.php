...
<body bgcolor="fffacd">
    <h3 align="center"><u>Update Form</u></h3>
    <center>
        <form action="update1.php" method="POST">
            ...
            <p align="center">
                <input type="Submit" value="update" title="Click here to submit your data.">
    ...
    <table border="2" align="center">
        ...
        <?php
            ...
            <tr>
                ...
                <td>
                    <a href="update1.php?id=<?php echo $row[0]; ?>">update_row</a>
                </td>
